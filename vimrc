...
"autocmd FileWritePre,BufWritePre * :Autoformat
noremap <C-f> :Autoformat<CR><CR>
"let g:auto_save=1
let g:formatprg_args_cpp = "--mode=c --style=google -pcHs4"
...
" Rust Support
let g:racer_cmd = "/Users/zonyitoo/Projects/racer/target/release/racer"
